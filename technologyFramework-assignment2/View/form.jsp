...
<head>
    ...
    <script src="_ui/js/jquery-3.0.0.min.js" ></script>
	<script src="_ui/js/angular.min.js" ></script>
    <script src="_ui/js/applications.js"></script>
	<script src="_ui/js/controllers.js" ></script>
</head>
<body ng-app="carForm">
		...
		<form action="savedetails" method="POST">
			...
			<div class="row">
				<div class="form-group col-xs-12">
				    ...
				    <div class="col-xs-5">
				        <input type="text" class="form-control" id="ac" name="ac" ng-model="car.ac" required>
				    </div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-12">
				    ...
				    <div class="col-xs-5">
				        <input type="text" class="form-control" id="steering" name="steering" ng-model="car.powerSteering" required>
				    </div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-12">
				    ...
				    <div class="col-xs-5">
				        <input type="text" class="form-control" id="kit" name="kit" ng-model="car.accessoryKit" required>
				    </div>
				</div>
			</div>
			<div class="row">
